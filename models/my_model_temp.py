...
def get_model(point_cloud, is_training, num_class, bn_decay=None):
    ...
    # Layer 1
    l1_xyz, l1_points = pointnet_sa_module_msg(l0_xyz, l0_points, 1024, [0.1, 0.2, 0.4], [16, 32, 128],[[32,32,64],[64, 64, 128],[64,96,128]], is_training, bn_decay=bn_decay, scope='layer1', use_nchw=True)
    l2_xyz, l2_points = pointnet_sa_module_msg(l1_xyz, l1_points, 256, [0.1, 0.3, 0.5], [32,64,128],[[64,64,128], [128,128,256], [128,128,256]], is_training, bn_decay=bn_decay, scope='layer2')
