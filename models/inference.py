...
def main_processor(input_queue, output_queue):
    with tf.Graph().as_default():
        ...
        saver = tf.train.import_meta_graph('/home/xaserver/Documents/Contest2019/shp/track4/pointnet2/data/base_line/baseline_model/model.ckpt-303800.meta')
        saver.restore(sess, tf.train.latest_checkpoint("/home/xaserver/Documents/Contest2019/shp/track4/pointnet2/data/base_line/baseline_model/"))
    ...
    while True:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            pipeline = {'pipeline':[
                    ...
                    opath]}
            p = subprocess.run(['/home/xaserver/anaconda3/envs/cpdal-run/bin/pdal','pipeline','-s'],input=json.dumps(pipeline).encode())
            if p.returncode:
