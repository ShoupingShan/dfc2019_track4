...
parser.add_argument('--normal', action='store_true', help='Whether to use normal information')  #如果命令行参数不指定的话，默认为False
...
HOSTNAME = socket.gethostname()  #shp
...
def train():
    with tf.Graph().as_default():
        with tf.device('/gpu:'+str(GPU_INDEX)):
            ...
            is_training_pl = tf.placeholder(tf.bool, shape=())  #is_training_pl = is not None
